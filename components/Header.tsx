...
export default function Header({ showConversationSelector }: { showConversationSelector: boolean }) {
  ...
  return (
    <AppBar
      sx={{ display: 'flex', flexDirection: 'row', alignItems:"center", justifyContent: 'space-between', position: 'static', padding: '0.75rem' }}
    >
      ...
      <Typography variant='h1' sx={{justifySelf: "center"}}>{process.env.NEXT_PUBLIC_APP_NAME} Chat</Typography>
      <Box flex="1">
