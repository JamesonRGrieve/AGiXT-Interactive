...
export function VoiceInputButton() {
  ...
  const { addFile, disabled, loading, enableVoiceInput } = useChatInput();
  ...
  const stopRecording = useCallback(() => {
    ...
    reader.onloadend = () => {
      ...
      addFile(new File([base64Audio], 'recording.wav', { type: 'audio/wav' }));
    };
  ...
  return (
    <InputAdornmentButton
      ...
      className={cn('transition-all duration-300 ease-in-out rounded-full', isRecording && 'bg-red-500 hover:bg-red-600')}
    >
